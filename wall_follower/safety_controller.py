...
class SafetyController(Node):
    ...
    def laser_callback(self, scan_msg: LaserScan):
        ...
        # Compute safety distance: always at least 0.5, or [distance, velocity] for [[0.6, 1.0], [0.7, 2.0], [0.8, 3.0], [0.9, 4.0], [1.0, 5.0]].
        safety_distance = max(0.5, 0.1 * self.velocity + 0.5)
